...
| [2026-09-12-launcher-hook-repair.json](verification/2026-09-12-launcher-hook-repair.json) | Historical hook repair and September 15 intact launcher: private install/legacy rollback/routes and production activation passed; existing native Codex receiver auto-bound. |

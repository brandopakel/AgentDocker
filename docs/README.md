...
| [Desktop UX](DESKTOP-UX.md) | Implemented home/Tools simplification and capability evidence. PR #150 adds the Messages workspace, archived conversations, unread/read state, threads and separate drafts; current-main integration passed 999 Rust tests, 77 Python checks and 233 native workflow steps. Final CI/review, physical input and installed-candidate acceptance remain. |

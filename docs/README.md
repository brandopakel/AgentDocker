...
| [Windows port](WINDOWS-PORT.md) | Daemon/CLI foundation complete in #206. Open #210 and follow-ups passed 284 native tests and 50 daemon/CLI/desktop steps on `cadf3d58`, including ConPTY, crash recovery, protected SQLite files and a fresh-home graphical launch. Integration, physical terminal/input, broader GUI, service, installer and real-provider acceptance remain; no Windows desktop download is available. |

...
| --- | --- | --- | --- |
| 1 | Integrate reviewed implementation | Done: #191 `abec6ec`, #196 `bfd79ff`, #194 `615ae79`, #199 `7022ead`, #198 `181d78b`, #201 `57a9d4e`, #202 `14f1c519`; connector changes are also on main. Open: #203 session presentation, #200 shared-chat workspace and #204 build-campaign ownership. | Finish final-head CI/review and merge these three. CodeRabbit rate-limit notices on #203/#204 are not substantive reviews; independent reviews and passing tests remain recorded. |

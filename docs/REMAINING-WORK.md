...
Reconnect integration retains the optional retired names added by the Messages review, including existing aliases flattened through another session fold. Missing legacy names remain unknown. Combined validation is pending.

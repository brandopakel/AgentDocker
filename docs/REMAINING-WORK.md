...
PRs #98–#113 have merged after final CI and actual source review (latest merge
`b257bcb`). Delivered work includes the simpler Current/Needs input/History

...
receipts. A private Codex 0.154.0 API trial passed, but source/integration gates
and crash recovery acceptance remain pending. Existing standalone TUI delivery

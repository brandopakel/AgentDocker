...
| Next | Reliable Codex incoming-message delivery | Add delivery and acknowledgement at supported lifecycle boundaries; prove a queued message reaches model context and receives a correlated reply. Current Codex hooks report activity; MCP clients must explicitly read or wait. | [Activity and messaging](ACTIVITY-AND-MESSAGING.md), [guided setup](GUIDED-SETUP.md) |

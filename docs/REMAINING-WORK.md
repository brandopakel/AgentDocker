...
PRs #98–#110 have merged after final CI and actual source review (latest merge
`d89a85c`). Delivered work includes the simpler Current/Needs input/History

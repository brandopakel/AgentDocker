...
`4fb3ae8` after all final workflows. The task board (#176), persisted message drafts (#178), and preserved resume
state (#179) have merged after final review and all five CI workflows; they
are not yet installed. Startup ordering (#180) is the last pending source PR
for the already tested combined candidate `d14610b7`.

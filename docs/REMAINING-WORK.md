...
September 16 read-only verification confirms installed `1e90f83` (schema21,
release `3add4bea`), daemon PID 3366 and GUI PID 4519 from that release. The
existing Codex provider PID 51242 and native receiver PID 94744 remain running.
PR #160 merged as `37725fe` after final review and CI. This installed observation
does not complete existing-session reconnect or all provider receipts.

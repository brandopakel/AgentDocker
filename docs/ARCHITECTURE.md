...
Priority is [PRODUCT-DIRECTION.md](PRODUCT-DIRECTION.md#delivery-order): verify the restore/privacy fixes through the staged trial, complete desktop packaging and onboarding, then deliver Linux desktop and Windows parity. Policy/quotas (15), supervision policy (16), descriptor handoff (28), the `commit` half of 10 and federation (17) remain backlog items.

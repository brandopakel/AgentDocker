...
| 36 | ✅ persisted message drafts: text-only, bounded, restored as unsent; PR #178 merged and installed; actual conversation draft close/reopen verified; question-answer drafts are extended in source with original IDs and no restored approval/send state (validation pending); other forms remain window-local | 5 | 30 |

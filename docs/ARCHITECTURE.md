...
Priority is [PRODUCT-DIRECTION.md](PRODUCT-DIRECTION.md#delivery-order): verify the restore and privacy fixes through the staged trial, complete desktop packaging and onboarding, then deliver Linux desktop and Windows parity. Policy and quotas (15), supervision policy (16), the descriptor handoff (28), `commit` (10) and the rtk view (26) are now built. What remains is Windows (20) and federation (17), both platform work rather than product work: 20 is named pipes, a Windows service and process inspection, and 17 depends on it.
